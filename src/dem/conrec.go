...
// // Point is a simple Representation of a point
// type Point struct {
// 	X, Y float64
// }

// // Line is a simple Representation of line
// type Line struct {
// 	p1, p2 Point
// }
...
type conrecLine func(i, j int, l orb.LineString, height float64)
				...
				*/
				...
				for m := 1; m <= 4; m++ {
					...
					case 1: // Line between vertices 1 and 2
						p1 = orb.Point{xh[m1], yh[m1]}
						p2 = orb.Point{xh[m2], yh[m2]}

					case 2: // Line between vertices 2 and 3
						p1 = orb.Point{xh[m2], yh[m2]}
						p2 = orb.Point{xh[m3], yh[m3]}

					case 3: // Line between vertices 3 and 1
						p1 = orb.Point{xh[m3], yh[m3]}
						p2 = orb.Point{xh[m1], yh[m1]}

					case 4: // Line between vertex 1 and side 2-3
						p1 = orb.Point{xh[m1], yh[m1]}
						p2 = orb.Point{sect(h, xh, m2, m3), sect(h, yh, m2, m3)}

					case 5: // Line between vertex 2 and side 3-1
						p1 = orb.Point{xh[m2], yh[m2]}
						p2 = orb.Point{sect(h, xh, m3, m1), sect(h, yh, m3, m1)}

					case 6: // Line between vertex 3 and side 1-2
						p1 = orb.Point{xh[m3], yh[m3]}
						p2 = orb.Point{sect(h, xh, m1, m2), sect(h, yh, m1, m2)}

					case 7: // Line between sides 1-2 and 2-3
						p1 = orb.Point{sect(h, xh, m1, m2), sect(h, yh, m1, m2)}
						p2 = orb.Point{sect(h, xh, m2, m3), sect(h, yh, m2, m3)}

					case 8: // Line between sides 2-3 and 3-1
						p1 = orb.Point{sect(h, xh, m2, m3), sect(h, yh, m2, m3)}
						p2 = orb.Point{sect(h, xh, m3, m1), sect(h, yh, m3, m1)}

					case 9: // Line between sides 3-1 and 1-2
						p1 = orb.Point{sect(h, xh, m3, m1), sect(h, yh, m3, m1)}
						p2 = orb.Point{sect(h, xh, m1, m2), sect(h, yh, m1, m2)}
					...
					fn(i, j, orb.LineString{p1, p2}, heights[k])
				}
			}
		}
	}
